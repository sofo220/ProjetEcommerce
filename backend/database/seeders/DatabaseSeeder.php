...
class DatabaseSeeder extends Seeder
{
    public function run()
    {
        ...
        Product::updateOrCreate(['slug' => 'lot-serviettes'], ['category_id' => $catMaison->id, 'name' => 'Lot serviettes de bain', 'price' => 249.00, 'stock' => 80, 'description' => '3 serviettes 100% coton doux.', 'image' => 'https://images.pexels.com/photos/4210373/pexels-photo-4210373.jpeg?auto=compress&cs=tinysrgb&w=900']);
        ...
        $clientProducts = [
            ...
            ['slug' => 'chargeur-rapide-usb-c-65w-client', 'category_id' => $catElectro->id, 'name' => 'Chargeur rapide USB-C 65W', 'price' => 179.00, 'stock' => 60, 'description' => 'Chargeur compact compatible téléphone, tablette et ordinateur portable.', 'image' => 'https://images.unsplash.com/photo-1583863788434-e58a36330cf0?w=900&auto=format&fit=crop&q=80'],
